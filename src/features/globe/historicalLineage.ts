 ...
 * Ensures uncataloged ancient tribes/cultures get distinct, repeatable pastel colors.
 */
...
export const HISTORICAL_LINEAGE_RULES: LineageRule[] = [
  // ==========================================
  // 1. Prehistoric & Archaeological Hunter-Gatherers / Foragers
  // ==========================================
  ...
  { pattern: /khoiasan|khoisan|khoikhoi|san\b|bushm[ae]n/i, lineageId: "khoisan", canonicalName: "Khoisan Peoples", baseColor: "#ca8a04", cultureGroup: "Southern Africa" },
  ...
  { pattern: /saharan pastoral nomads|tuareg|berber tribes|berbers|numidia|mauretania|moors/i, lineageId: "berber-saharan", canonicalName: "Berber & Saharan Peoples", baseColor: "#b45309", cultureGroup: "North Africa" },
  { pattern: /alluvial lowland|coastal and woodland|highland mesolithic|steppe mesolithic|mesolithic|neolithic farmers|levantine corridor|shellfish gatherers|hunters-gatherers|archaic amerindian/i, lineageId: "prehistoric-foragers", canonicalName: "Prehistoric Foragers & Early Farmers", baseColor: "#64748b", cultureGroup: "Prehistoric & Archaeological" },
  ...
  { pattern: /bell-shaped|beaker|funnel-beaker|corded ware|hallstatt|la tène|lusatian|pomeranian|milograd|chernoles|catacomb|kelteminar|karasuk|dapenkeng|dakapeng|austroasian rice|austro-asiatic rice|jomon|jōmon|brushed pottery|plain-pottery|masurian culture|sambian|okhotsk/i, lineageId: "eurasian-archaeological", canonicalName: "Eurasian Archaeological Cultures", baseColor: "#78716c", cultureGroup: "Prehistoric & Archaeological" },

  // ==========================================
  // 2. North American Indigenous Peoples & First Nations
  // ==========================================
  { pattern: /plain bison hunters|blackfoot|siksika|kainai|piegan|cheyenne|arapaho|sioux|lakota|dakota|nakota|crow|apsaalook|pawnee|kiowa|g[aá]uig[uú]|comanche|osage|omaha|ponca|kansa|kaw\b|quapaw|wichita|caddo|tonkawa|arikara|hidatsa|mandan|assiniboine|gros ventre|atsina/i, lineageId: "great-plains-indigenous", canonicalName: "Great Plains Indigenous Nations", baseColor: "#d97706", cultureGroup: "North American Indigenous" },
  { pattern: /desert hunter-gatherers|apache|chiricahua|mescalero|jicarilla|lipan|navajo|din[eé]|pueblo|hopi|zuni|taos|tewa|tiwa|towa|keres|hohokam|anasazi|mogollon|havasupai|havasu|hualapai|yavapai|mojave|maricopa|quechan|cocopa|cahuilla|luiseño|tongva|chumash|yokuts|miwok|pomo|wintun|maidu|shoshone|paiute|ute\b|goshute|washoe|akimel|pima|acjachemen/i, lineageId: "southwest-california-indigenous", canonicalName: "Southwest & California Indigenous Nations", baseColor: "#ca8a04", cultureGroup: "North American Indigenous" },
  { pattern: /plateau fichers|plateau fishers|north american pacifi|coast salish|salish|haida|tlingit|ling[ií]t|tsimshian|nisga|gitxsan|gitx|haisla|heiltsuk|nuxalk|kwakwaka|kwakiutl|nuu-chah|nootka|makah|quileute|quinault|chehalis|chinook|tillamook|siletz|grand ronde|umpqua|cow creek|coos|coquille|klamath|modoc|yurok|karuk|hupa|nez perce|nimiipuu|yakama|umatilla|spokane|kalispel|flathead|kootenai|shuswap|secwepemc|okanagan|carrier|dakelh|twana|skokomish|wailaki|achumawi/i, lineageId: "pacific-northwest-indigenous", canonicalName: "Pacific Northwest & Plateau First Nations", baseColor: "#047857", cultureGroup: "North American Indigenous" },
  { pattern: /eastern north amer|cherokee|creek|muscogee|mvskoke|choctaw|chickasaw|seminole|iroquois|haudenosaunee|mohawk|oneida|onondaga|cayuga|seneca|tuscarora|huron|wendat|wyandot|algonq|ojibwe|chippewa|anishinaabe|cree\b|shawnee|miami|illinois|potawatomi|ottawa|menominee|ho-chunk|winnebago|sauk|meskwaki|kickapoo|iowa|powhatan|pamunkey|mattaponi|lenape|delaware|nanticoke|piscataway|susquehannock|wampanoag|narragansett|mohegan|pequot|abenaki|mi.kma|maliseet|passamaquoddy|quinnipiac|neutral|attiwonderonk|timucua|calusa|apalachee|catawba|yuchi|chickahominy|cheraw|atakapa/i, lineageId: "eastern-woodlands-indigenous", canonicalName: "Eastern Woodlands First Nations", baseColor: "#15803d", cultureGroup: "North American Indigenous" },
  ...
  { pattern: /totonac|huastec|pipil|lenca|chorotega|nicarao|miskito|guna|kuna|guaym|guachichil|n[aá]ayerite|cora\b|ayuukj/i, lineageId: "mesoamerican-states", canonicalName: "Mesoamerican & Central American Indigenous States", baseColor: "#10b981", cultureGroup: "Mesoamerican" },

  // ==========================================
  // 4. South American Indigenous Civilizations & Peoples
  // ==========================================
  { pattern: /andean hunter|chinchorro|valdivia|chorrera|chavin|chavín|paracas|nazca|moche|tiwanaku|tiahuanaco|wari|huari|chimu|chimú|inca|tawantinsuyu|kichwa|chachapoya|chancay|chincha|huanca|chanca|colla|lupaca|cañari|quitu|cayubaba/i, lineageId: "andean-civilizations", canonicalName: "Andean Civilizations & Inca", baseColor: "#d97706", cultureGroup: "Andean" },
  { pattern: /muisca|tairona|quimbaya|zenú|san agust|calima|tolita|pasto/i, lineageId: "chibcha-colombian", canonicalName: "Chibcha & Northern Andean Civilizations", baseColor: "#ca8a04", cultureGroup: "Andean" },
  ...
  { pattern: /pampas cultures|patagonian shellfish|tehuelche|a[oó]nikenk|selk|ona\b|yaghan|y[aá]mana|kaw[eé]sqar|charr[uú]a|mapuche|araucan|diaguita|het\b|puelche|pehuenche|huilliche/i, lineageId: "southern-cone-indigenous", canonicalName: "Southern Cone & Pampas Peoples", baseColor: "#a16207", cultureGroup: "South American Indigenous" },
  ...
  { pattern: /fiji|papua|papuan|melanesian|vanuatu|solomon islands|solomon is|new caledonia|kanak/i, lineageId: "melanesia", canonicalName: "Melanesian Realms", baseColor: "#0d9488", cultureGroup: "Oceania" },
  ...
  // ==========================================
  { pattern: /scyth|proto-scythian|sarmat|saka\b|saka kingdom|massagetae|yuezhi|wusun|alans|caucasian alans|xiongnu|hun\b|huns|hephthalite|rouran|juan-juan/i, lineageId: "ancient-steppe-nomads", canonicalName: "Ancient Steppe Nomadic Confederations", baseColor: "#0369a1", cultureGroup: "Central Asia" },
  { pattern: /göktürk|gokturk|turkic khaganate|oghur|oghuz|uyghur|karluk|karakhanid|khazar|pecheneg|cuman|kipchak|avar\b|avars|bulgar khanate|volga bulgar/i, lineageId: "turkic-khaganates", canonicalName: "Turkic & Steppe Khaganates", baseColor: "#0284c7", cultureGroup: "Central Asia" },
  ...
  { pattern: /jomon|jōmon|yayoi|kofun|yamato|asuka|nara|heian|fujiwara|kamakura|muromachi|ashikaga|sengoku|azuchi|tokugawa|edo|japan|ryukyu|sanzan|chuzan/i, lineageId: "japan", canonicalName: "Japanese Dynasties & Kingdoms", baseColor: "#e11d48", cultureGroup: "East Asia" },
  { pattern: /korea|joseon|choson|goryeo|koryo|silla|silia|paekche|baekje|koguryo|goguryeo|gaya|parhae|balhae|buyeo|gojoseon/i, lineageId: "korea", canonicalName: "Korean Dynasties", baseColor: "#2563eb", cultureGroup: "East Asia" },
  { pattern: /shang|zhou|qin\b|han empire|han dynasty|three kingdoms|cao wei|shu han|eastern wu|jin dynasty|sixteen kingdoms|northern wei|northern qi|northern zhou|liu song|southern qi|liang dynasty|chen dynasty|sui dynasty|tang empire|tang dynasty|wu zhou|five dynasties|song empire|song dynasty|liao\b|khitan|western xia|tangut|jin \(jurchen\)|jurchen|dali kingdom|nanzhao|ming|qing|manchu|china|chinese|hainan|hong kong|macau|taiwan|formosa|tungning/i, lineageId: "china", canonicalName: "Imperial Chinese Dynasties", baseColor: "#dc2626", cultureGroup: "East Asia" },
  { pattern: /tibet|zhangzhung|yarlung|tuyuhun|tsongkha|phagmodrupa|ganden phodrang/i, lineageId: "tibet", canonicalName: "Tibetan Realm", baseColor: "#ca8a04", cultureGroup: "Central Asia" },

  // ==========================================
  // 8. South Asia & Indian Subcontinent
  // ==========================================
  { pattern: /indus valley|harapp|mehrgarh/i, lineageId: "indus", canonicalName: "Indus Valley Civilization", baseColor: "#d97706", cultureGroup: "South Asia" },
  { pattern: /maurya|magadha|kalinga|shunga|kanva|nanda empire|mahajanapada/i, lineageId: "maurya", canonicalName: "Mauryan & Early Indian Empires", baseColor: "#ea580c", cultureGroup: "South Asia" },
  { pattern: /gupta|vakataka|harsha|pushyabhuti|maitraka|maukhari/i, lineageId: "gupta", canonicalName: "Gupta & Classical Indian Empires", baseColor: "#f59e0b", cultureGroup: "South Asia" },
  { pattern: /chola|pallava|pandya|chalukya|satavahana|satavahanihara|rashtrakuta|hoysala|kakatiya|ganga\b|western ganga|eastern ganga|gajapati|cheras?|kadamba|yadava|seuna|reddy|nayak|vijayanagar|dravidian/i, lineageId: "dravidian-dynasties", canonicalName: "Southern & Deccan Indian Kingdoms", baseColor: "#c2410c", cultureGroup: "South Asia" },
  { pattern: /pala\b|palas|sena\b|gurjara|pratihara|rajput|chandela|paramara|solanki|chaulukya|kalachuri/i, lineageId: "medieval-north-india", canonicalName: "Medieval Indian Kingdoms", baseColor: "#ea580c", cultureGroup: "South Asia" },
  ...
  { pattern: /nepal|gorkha|malla|licchavi|bhutan|drukpa|sikkim|ladakh|guge/i, lineageId: "himalayan-kingdoms", canonicalName: "Himalayan Kingdoms", baseColor: "#dc2626", cultureGroup: "South Asia" },
  ...
  { pattern: /siam|ayutthaya|sukhothai|dvaravati|hariphunchai|lavo|lan na|chiang mai|rattanakosin|thailand/i, lineageId: "siam", canonicalName: "Siamese & Tai Kingdoms", baseColor: "#2563eb", cultureGroup: "Southeast Asia" },
  ...
  { pattern: /burma|pagan|ava\b|pegu|hanthawaddy|arakan|mrauk u|toungoo|konbaung|pyu\b|thaton|myanmar/i, lineageId: "burma", canonicalName: "Burmese Kingdoms", baseColor: "#ca8a04", cultureGroup: "Southeast Asia" },
  ...
  { pattern: /srivijaya|majapahit|mataram|medang|kediri|singhasari|kahuripan|sunda|galuh|pajajaran|demak|banten|cirebon|aceh|malacca|melaka|johor|perak|pahang|selangor|kedah|terengganu|kelantan|malay|brunei|sulu|maguindanao|butuan|cebu|tondo|maynila|madja-as|minang|pagaruyung|palembang|jambi|kutai|banjar|pontianak|gowa|makassar|bone|luwu|tidore|ternate|dutch east indies|philippines|indonesia/i, lineageId: "nusantara", canonicalName: "Maritime Southeast Asia (Nusantara)", baseColor: "#047857", cultureGroup: "Southeast Asia" },

  // ==========================================
  // 10. Ancient Near East, Mesopotamia & Iran
  // ==========================================
  { pattern: /sumer|uruk|ur\b|lagash|kish\b|nippur|akkad|babylon|assyria|elam|mitanni|kassite|hurrian|amorite|urartu|ebla|mari\b/i, lineageId: "ancient-mesopotamia", canonicalName: "Mesopotamian Civilizations", baseColor: "#b45309", cultureGroup: "Ancient Near East" },
  { pattern: /canaan|phoenic|tyre|sidon|byblos|philist|israel|judah|judea|samaria|aramean|aram\b|nabatae|palmyra|ghassanid|lakhmid/i, lineageId: "ancient-levant", canonicalName: "Ancient Levantine Civilizations", baseColor: "#ca8a04", cultureGroup: "Ancient Near East" },
  { pattern: /hatti|hittite|luwian|phrygia|lydia|caria|lycia|cilicia|pontus|cappadocia|commagene|armenia|artaxiad|bagratid/i, lineageId: "ancient-anatolia", canonicalName: "Anatolian & Armenian Kingdoms", baseColor: "#d97706", cultureGroup: "Ancient Near East" },
  { pattern: /persia|achaemenid|parthia|arsacid|sasanian|sassanid|medes|tahirid|saffarid|samanid|buyid|safavid|afsharid|zand|qajar|suren/i, lineageId: "persia", canonicalName: "Persian & Iranian Empires", baseColor: "#0d9488", cultureGroup: "Iranian" },
  { pattern: /hadramaut|yemen|saba\b|sabaean|himyar|qataban|kindah|muscat|oman|arabian pastoral|bedouin|arabs|islamic city-states|white sheep turks|black sheep turks|aq qoyunlu|qara qoyunlu/i, lineageId: "arabian-peninsula", canonicalName: "Arabian & Gulf Emirates", baseColor: "#047857", cultureGroup: "Middle East" },
  ...
  // ==========================================
  { pattern: /ancient egypt|predynastic egypt|old kingdom egypt|middle kingdom egypt|new kingdom egypt|egypt|ptolemaic/i, lineageId: "egypt", canonicalName: "Egyptian Civilization", baseColor: "#d97706", cultureGroup: "North Africa" },
  { pattern: /nubia|kush|meroe|kerma|nobatia|makkura|makuria|alwa|blemmyes/i, lineageId: "nubia", canonicalName: "Nubian Kingdoms", baseColor: "#ca8a04", cultureGroup: "East Africa" },
  { pattern: /axum|aksum|damot|d.mt|abyssinia|ethiopia|shewa|shoa|zagwe|oromo/i, lineageId: "ethiopia", canonicalName: "Ethiopian Realm", baseColor: "#15803d", cultureGroup: "East Africa" },
  ...
  { pattern: /ghana|empire of ghana|wagadou|mali\b|songhai|kanem|bornu|bornu-kanem|hausa|mossi|wadai|sokoto|fulani|toucouleur|wassoulou|jolof|wolof|sine\b|saloum|kaabu|fouta/i, lineageId: "sahelian-empires", canonicalName: "Sahelian & Western Sudanese Empires", baseColor: "#ca8a04", cultureGroup: "West Africa" },
  { pattern: /benin|oyo|dahomey|ashanti|asante|fante|yoruba|igbo|nri\b|aro\b|nupe|igala|akan\b/i, lineageId: "gulf-of-guinea", canonicalName: "Gulf of Guinea Kingdoms", baseColor: "#ea580c", cultureGroup: "West Africa" },
  { pattern: /kongo|congo|ndongo|matamba|loango|kakongo|ngoyo|anziku|tio\b|luba|lunda|kuba|kazembe|maravi/i, lineageId: "central-african-kingdoms", canonicalName: "Central African Kingdoms", baseColor: "#0284c7", cultureGroup: "Central Africa" },
  { pattern: /buganda|bunyoro|ankole|toro\b|rwanda|burundi|swahili|kilwa|zanzibar|mombasa|lamu|pate|malindi|sofala|darfur|funj|sennar/i, lineageId: "great-lakes-swahili", canonicalName: "Great Lakes & Swahili Kingdoms", baseColor: "#0d9488", cultureGroup: "East Africa" },
  { pattern: /great zimbabwe|zimbabwe|mutapa|mwenemutapa|rozwi|rozvi|butua|mapungubwe|zulu|swazi|swaziland|lesotho|basutoland|gaza\b|mthethwa|ndwandwe|xhosa/i, lineageId: "southern-african-kingdoms", canonicalName: "Southern African Kingdoms", baseColor: "#ca8a04", cultureGroup: "Southern Africa" },
  ...
  { pattern: /roman empire|rome|roman republic|roman kingdom/i, lineageId: "rome", canonicalName: "Roman Empire", baseColor: "#831843", cultureGroup: "Greco-Roman" },
  ...
  { pattern: /greek|sparta|athens|thebes|corinth|argos|rhodes|cycladic|minoan|mycenaean|greek city-states/i, lineageId: "greece", canonicalName: "Ancient Greece", baseColor: "#0284c7", cultureGroup: "Greco-Roman" },
  { pattern: /etruscan|samnite|umbrian|italic|nuragic|dumonii|dacia|odrysian|boihaenum/i, lineageId: "classical-mediterranean-tribes", canonicalName: "Ancient European & Mediterranean Civilizations", baseColor: "#b45309", cultureGroup: "Southern Europe" },
  ...
  { pattern: /goth|visigoth|ostrogoth|vandal|suebi|burgundian|lombard|alemann|saxon|frank|carolingian|merovingian|anglo-saxon|frisian|thuringian/i, lineageId: "germanic-tribes", canonicalName: "Germanic & Migration Kingdoms", baseColor: "#2563eb", cultureGroup: "Western Europe" },
  ...
  { pattern: /england|great britain|british empire|united kingdom|britain/i, lineageId: "britain", canonicalName: "British Realm", baseColor: "#1d4ed8", cultureGroup: "Western Europe" },
  { pattern: /castille|castile|arag[oó]n|navarre|asturias|le[oó]n|spain/i, lineageId: "spain", canonicalName: "Spanish Kingdoms", baseColor: "#dc2626", cultureGroup: "Southern Europe" },
  ...
  { pattern: /kievan rus|principality of moscow|grand duchy of moscow|tsardom of russia|tsardom of muscovy|russian empire|ussr|soviet union|white russia|novgorod|pskov|ryazan|vladimir-suzdal|russia/i, lineageId: "russia", canonicalName: "Russian State", baseColor: "#be123c", cultureGroup: "Slavic" },
  ...
  { pattern: /belgium|netherlands|luxembourg|flanders|brabant|dutch/i, lineageId: "low-countries", canonicalName: "Low Countries", baseColor: "#ea580c", cultureGroup: "Western Europe" },
