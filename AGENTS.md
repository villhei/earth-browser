...
`earth-browser` is an interactive 3D WebGL historical Earth atlas that visualizes sovereign boundaries, cultural spheres, and historical empires across **53 historical eras** (from 123,000 BCE to 2010 CE).
...
│   └── seed/                                      # 53 Historical GeoJSON datasets (world_*.geojson)
├── src/
│   ├── app/
...
│   │   ├── eraMetadata.ts      # Catalog of 53 historical eras with chronological metadata
